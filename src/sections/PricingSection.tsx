    ...
    return TIERS.map((t) => {
      ...
      const subtext =
        t.id === "enterprise"
          ...
          : `${currencySymbol}${displayPrice} billed annually (${yearlyDiscountPctDefault}% off${
              withHosting ? ", hosting included" : ""
            })`;
      return { ...t, displayPrice, suffix, subtext };
    });
  }, [billing, withHosting, yearlyDiscountPctDefault]);
          ...
          {computed.map((tier) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex h-full flex-col rounded-2xl border p-6 text-left shadow-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400",
                  tier.highlight
                ...
                <div className="mt-auto">
                  <a
                    ...
                    className={cn(
                      ...
                      tier.id === "enterprise"
                        ? "bg-indigo-400/20 text-indigo-200 ring-1 ring-inset ring-indigo-400/40 hover:bg-indigo-400/30"
                        : tier.highlight
